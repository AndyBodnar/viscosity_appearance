...
function Radial.AddOption(currentZone)
    ...
    local event, title
    local zoneEvents = {
        clothingRoom = {"viscosity_appearance:client:OpenClothingRoom", _L("menu.title")},
        playerOutfitRoom = {"viscosity_appearance:client:OpenPlayerOutfitRoom", _L("menu.outfitsTitle")},
        clothing = {"viscosity_appearance:client:openClothingShopMenu", _L("menu.clothingShopTitle")},
        barber = {"viscosity_appearance:client:OpenBarberShop", _L("menu.barberShopTitle")},
        tattoo = {"viscosity_appearance:client:OpenTattooShop", _L("menu.tattooShopTitle")},
        surgeon = {"viscosity_appearance:client:OpenSurgeonShop", _L("menu.surgeonShopTitle")},
    }
