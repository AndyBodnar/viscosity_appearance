...
RegisterNetEvent("viscosity_appearance:client:migration:load-qb-clothing-skin", function(playerSkin)
    ...
    Citizen.CreateThread(function()
        ...
        TriggerEvent("viscosity_appearance:client:migration:load-qb-clothing-clothes", playerSkin, cache.ped)
        SetModelAsNoLongerNeeded(model)
    end)
end)

RegisterNetEvent("viscosity_appearance:client:migration:load-qb-clothing-clothes", function(playerSkin, ped)
    ...
    TriggerServerEvent("viscosity_appearance:server:migrate-qb-clothing-skin", playerSkin.citizenid, appearance)
end)
