...
RegisterNetEvent("viscosity_appearance:client:loadJobOutfit", LoadJobOutfit)

RegisterNetEvent("viscosity_appearance:client:openOutfitMenu", function()
    OpenMenu(nil, "outfit")
end)

RegisterNetEvent("viscosity_appearance:client:outfitsCommand", function(isJob)
    local outfits = GetPlayerJobOutfits(isJob)
    TriggerEvent("viscosity_appearance:client:openJobOutfitsMenu", outfits)
end)
